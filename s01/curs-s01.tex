...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4d7db63}]{Etapa III: Minimum Viable Product}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org2e88e36}]{Etapa IV: Dezvoltarea în iterații}
\begin{itemize}
\item Cerințele sunt ordonate în funcție de importanță.
\item Echipa alege \(N\) cele mai importante cerințe.
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbe843be}]{Etapa IV: Dezvoltarea în iterații (cont.)}
\begin{itemize}
\item Mai întâi se planifică abordarea (task breakdown).
\item Fiecare membru ia câte o sarcină.
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org63057ae}]{Etapa IV: Dezvoltarea în iterații (cont.)}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org71e3089}]{Etapa IV: Dezvoltarea în iterații (cont.)}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd91bad6}]{Etapa V: Lansarea în producție}
\begin{itemize}
