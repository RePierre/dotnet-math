...
\label{sec:org66085e1}
\begin{frame}[label={sec:org2bc0ea8},fragile]{Ce este un ORM}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgaae19f6},fragile]{Entity Framework}
 \begin{block}{Entity Framework}
Este o bibliotecă pentru platforma \texttt{.net} care oferă funcționalitatea \texttt{ORM}.
\end{block}
\end{frame}
\begin{frame}[label={sec:org6c61762},fragile]{Fluxuri de lucru}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orga0724cc},fragile]{Alegerea fluxului de lucru\footnote{\url{https://docs.microsoft.com/en-us/ef/ef6/modeling/\#ef-workflows}}}
 \begin{center}
\begin{tabular}{lll}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga2d69c7}]{Definirea modelului}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgbc74b42}]{Definirea modelului}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org28612e1},fragile]{Noțiuni de bază}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb3f2d18}]{Noțiuni de bază}
\begin{block}{Entity}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2b4669f},fragile]{Noțiuni de bază}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5395189}]{Noțiuni de bază}
\begin{block}{CRUD}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2686f6c},fragile]{Eager vs Lazy loading}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgee3318a},fragile]{Eager vs Lazy loading}
 \begin{itemize}
...
\label{sec:org736495b}
\begin{frame}[label={sec:orgcbef861},fragile]{Ce este \texttt{Repository}}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc42e399}]{Avantaje}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb30cd6e},fragile]{Exemplu}
 \begin{verbatim}
...
\end{frame}
\section{Încheiere}
\label{sec:org1341acc}
\begin{frame}[label={sec:org58f8f91}]{Recapitulare}
\pause
\begin{block}{LINQ}
\pause
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6eab77a}]{Vă mulțumesc!}
\begin{center}
