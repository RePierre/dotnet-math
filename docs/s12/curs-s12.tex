...
\label{sec:orgd90425f}
\begin{frame}[label={sec:orga88983c},fragile]{Primary/Foreign Key}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4613e27},fragile]{Relaţie}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org411032e}]{Exemplu: 1*N}
\begin{center}
\includegraphics[width=\textwidth]{img/one-to-many.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8954570}]{Exemplu\footnote{\url{https://smehrozalam.wordpress.com/2010/06/29/entity-framework-queries-involving-many-to-many-relationship-tables/}}: N*M}
\begin{center}
\includegraphics[width=.8\textwidth]{img/many-to-many.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orga7653d8}]{Normalizare}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0d82aec}]{Objective normalizare}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org71a8b3c},fragile]{Forme normale}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf02a5db},fragile]{Forma Normală 1}
 \begin{block}{FN1}
\vskip 0.1in
O relaţie este în \texttt{Forma Normală 1} dacă în fiecare coloană a unui tabel avem doar valori atomice.
\end{block}
\end{frame}
\begin{frame}[label={sec:org4a2ebe4},fragile]{Forma Normală 1}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orge50f95e},fragile]{Forma Normală 2}
 \begin{block}{FN2}
\vskip 0.1in
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org93ad5e8}]{Forma Normală 2}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge0d9976},fragile]{Forma Normală 3}
 \begin{block}{FN3}
\vskip 0.1in
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgef399ae}]{Forma Normală 3\footnote{\url{https://en.wikipedia.org/wiki/Third\_normal\_form}}}
\begin{center}
\begin{tabular}{lrl}
...
\end{frame}
\section{DevOps}
\label{sec:org6dab39a}
\begin{frame}[label={sec:org7a17569},fragile]{DevOps}
 \begin{block}{DevOps}
\vskip 0.1in
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8974d86},fragile]{Conductele de livrare}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0425565}]{Conductele de livrare: Motivaţie}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4bf04c0}]{Exemplu\footnote{\url{https://www.linux.com/audience/devops/devops-fundamentals-part-4-patterns-and-practices/}}}
\begin{center}
