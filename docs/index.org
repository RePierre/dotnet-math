...
** Laborator
   ...
   :CUSTOM_ID: s04-lab
   :END:
   Din cauza [[http://www.uaic.ro/uaic-a-decis-suspendarea-activitatii-didactice-si-a-evenimentelor-in-perioada-13-31-martie-2020/][deciziei Universității]] de suspendare temporară a cursurilor, tema va fi anunțată ulterior.
* Legături utile
  :PROPERTIES:
  :CUSTOM_ID: links
  :END:
