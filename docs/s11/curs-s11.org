...
** Execuţie asincronă
   ...
   2. Trimite interogare la baza de date pentru utilizaotul B
...
* Încheiere
** Recapitulare
   - =TPL= simplifică integrarea execuţiei paralele şi asincrone în aplicaţie lăsând în grija sistemului detaliile de nivel jos a.î. programatorul să se poată concentra asupra logicii aplicaţiei.
